...
@property (nonatomic) NSURLSessionConfiguration * __nonnull sessionConfiguration;
...
- (void)downloadImageWithURL:(NSURL * __nonnull)URL progressBlock:(void (^ __nullable)(int64_t, int64_t))progressBlock completionHandler:(void (^ __nullable)(UIImage * __nullable, NSError * __nullable, NSURL * __nullable, NSData * __nullable))completionHandler;
...
@property (nonatomic, readonly) UIActivityIndicatorView * __nullable kf_indicator;
@end
